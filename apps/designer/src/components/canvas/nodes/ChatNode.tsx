  ...
  return (
    <div
      ...
      style={{
        ...
        borderLeft: firstLaneColour ? `3px solid ${firstLaneColour}` : '1px solid #22c55e',
        boxShadow: isPlaying
          ? '0 0 0 4px rgba(34,197,94,1), 0 0 32px 8px rgba(34,197,94,0.55)'
          : wasVisited ? '0 0 0 3px rgba(34,197,94,0.55), 0 0 14px rgba(34,197,94,0.35)' : undefined,
