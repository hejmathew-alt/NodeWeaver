...
export function StartNode({ id, data }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      {/* No target handle — nothing connects TO start; no left handle — flow goes right */}
      <Handle type="source" position={Position.Right} id="right" style={{ width: 10, height: 10 }} className="!bg-teal-400" />
    </div>
  );
}
